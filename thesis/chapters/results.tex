\chapter{Experiements and Results}
%\section{Experiments}
...
elements (\prettyref{fig:8atoms}).
The ODL algorithm learns atoms similar to combinations of DCT atoms
((a) and (b)). Or similar to wavelet atoms ((c) and (d)).

With increasing block size more wavelet like atoms show up 
(\prettyref{fig:16atoms}). 

Our training sets consists of JPEG images \label{fig:16jpeg_atoms}. 

\begin{figure}[h]
\centering
\subfloat[]{\includegraphics[width = 0.2\textwidth]{images/gradient.png}}
\hspace{5mm}
\subfloat[]{\includegraphics[width = 0.2\textwidth]{images/checkerboard.png}}
\hspace{5mm}
\subfloat[]{\includegraphics[width = 0.2\textwidth]{images/edges.png}}
\hspace{5mm}
\subfloat[]{\includegraphics[width = 0.2\textwidth]{images/spot.png}}
...
\begin{figure}[h]
\centering
\subfloat{\includegraphics[width = 0.3\textwidth]{images/jpeg_atoms.png}}
...
\begin{figure}[h]
\centering
\subfloat{\includegraphics[width = 0.3\textwidth]{images/sketch_atoms.png}}
...
%But consists of multiple smaller dictionaries learned in clusters.
...
\prettyref{tab:compression1} for low bit rates but does not reach the JPEG 2000
...
(\prettyref{tab:compression2}) for low bit rates. \prettyref{fig:magnified} show
...
0.29\textwidth]{images/sketch_png.png}}
\hspace{5mm}
\subfloat[SPRS]{\includegraphics[width =
0.29\textwidth]{images/sketch_sprs.png}}
\hspace{25mm}
\subfloat[JPEG]{\includegraphics[width =
0.29\textwidth]{images/sketch_jpeg.png}}
\hspace{5mm}
\subfloat[JPEG2000]{\includegraphics[width =
0.29\textwidth]{images/sketch_2000.png}}
\caption{}
\label{fig:magnified}
\end{figure}
