...
on images from the training set. 
 \item Reconstruction quality of single learned dictionaries vs. dictionaries
merged from smaller dictionaries learnd in clusters.
 \item Reconstruction quality of outside of the training set.
 \item Inspection of the main structures of dictionary atoms from different
groups of images (natural, sketches).
 \item Compression quality of images from and outside of the training set.
\end{enumerate}
...
\begin{figure}[h]
\centering
\subfloat[300]{\includegraphics[width = 0.3\textwidth]{images/28979823.jpg}}
\hspace{5mm}
\subfloat[900]{\includegraphics[width = 0.3\textwidth]{images/28979823.jpg}}
\hspace{5mm}
\subfloat[3000]{\includegraphics[width = 0.3\textwidth]{images/28979823.jpg}}
