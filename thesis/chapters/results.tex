...
\begin{figure}[H]
\centering
\subfloat[50,000]{\includegraphics[width =
0.2\textwidth]{images/coeffsConvergOMP_0_1.jpg}}
\hspace{15mm}
\subfloat[1,000,000]{\includegraphics[width =
...
\begin{figure}[H]
\centering
\subfloat[natural dict]{\includegraphics[width =
0.5\textwidth]{images/natural_dict.jpg}}
\hspace{5mm}
\subfloat[sketch dict]{\includegraphics[width =
0.5\textwidth]{images/sketch_dict.jpg}}
\caption{evolution with 2 coefficents}
\label{fig:coeffsOMPsamples}
\end{figure}
