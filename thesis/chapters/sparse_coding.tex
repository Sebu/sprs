...
properties similar to those localized filtering of wavelets functions. Several
approaches were made to create system that resemble this phenomena but did not
...
algorithm known as least angle regression. Regression tries to find the
...
A pseudocode implementation can be found in \prettyref{alg:lars}.
\begin{algorithm}[H]
\caption{LARS-lasso}
\label{alg:lars}
\begin{algorithmic}[1]
