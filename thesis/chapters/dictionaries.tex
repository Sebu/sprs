...
where multiple instance of the same atom are part of the dictionary but in
form of additional atoms that resemble a composition of other atoms from
...
dictionaries. For example by adding rotated cosine atoms to a dictionary with
