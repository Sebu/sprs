...
\caption{generated bases (Lewicki et al.\cite{Lewicki1999})}
...
At each iteration $t$ \prettyref{alg:trainDL} draws a random sample $\vec{x}_t$
...
\paragraph{Hierarchy}%$A_0  \gets tI$ and $B_0 \gets tD$
...
individual dictionaries for each object group. Then  
Examples for sparse coding being used for classification tasks can
be found in \cite{Grosse2007,Mairal2008,Mairal2008b,Bar2009}.
%\cite{?} validation of fake paintings. 
