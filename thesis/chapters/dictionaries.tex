...
In section \ref{sec:dicts} we define our dictionaries are
collection of signal atoms. Dictionaries for sparse coding are indexed
collection of discrete signal atoms and a linear combination of a sparse
selection of atoms can will reconstruct signals.

\section{Structure}
Section \ref{sec:dicts} describes that dictionaries can capture the essential
structures of signals. But to achieve this quality they need the right
