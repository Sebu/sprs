...
dictionary $\vec{D}$. This approach uses a second sparse coding step to encode
the atoms of a bigger $\vec{D}$ dictionary with the help of a smaller dictionary
$\vec{B}$ and a sparse matrix $\vec{A}$. Leading to a reconstruction of
$\mat{D}=\mat{B}\mat{A}$.
